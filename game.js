...
game.bop = {
  ...
  draw: function(){
    ...
    atom.context.font = '75px monospace';
    atom.context.fillText('Score: ' + this.total, 300, 200);
    var time = 60
    setInterval(function(){time--},1000)
    setInterval(game.timer(),60000);
    atom.context.fillStyle = '#000';
    atom.context.font = '75px monospace';
    atom.context.fillText('Timer: ' + this.time, 300, 100);
  },
...
game.drawBackground = function(){
  ...
  atom.context.arc(atom.width/30, atom.height/10 -30, 90, Math.PI*2, 0); 
  atom.context.fill();
